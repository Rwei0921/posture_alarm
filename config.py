...
FALL_TRUNK_ANGLE_THRESHOLD_DEG = float(os.getenv("FALL_TRUNK_ANGLE_THRESHOLD_DEG", "60.0"))
FALL_HIP_SHOULDER_DIFF_THRESHOLD = float(os.getenv("FALL_HIP_SHOULDER_DIFF_THRESHOLD", "0.10"))
FALL_SPEED_THRESHOLD = float(os.getenv("FALL_SPEED_THRESHOLD", "0.30"))
FALL_SCORE_WINDOW_SIZE = int(os.getenv("FALL_SCORE_WINDOW_SIZE", "6"))
FALL_SCORE_THRESHOLD = float(os.getenv("FALL_SCORE_THRESHOLD", "0.67"))
FALL_EVENT_MIN_HIP_DROP = float(os.getenv("FALL_EVENT_MIN_HIP_DROP", "0.15"))
FALL_EVENT_WINDOW_SECONDS = float(os.getenv("FALL_EVENT_WINDOW_SECONDS", "1.0"))
